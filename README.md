...
### .Net 10.0
[![build 10.0](https://github.com/MetaFrm/MetaFrm.Service.ClientApi/actions/workflows/build_10.0.yml/badge.svg)](https://github.com/MetaFrm/MetaFrm.Service.ClientApi/actions/workflows/build_10.0.yml)
[![NuGet version (MetaFrm.Service.ClientApi.net10.0)](https://img.shields.io/nuget/v/MetaFrm.Service.ClientApi.net10.0)](https://www.nuget.org/packages/MetaFrm.Service.ClientApi.net10.0/)
[![NuGet downloads (MetaFrm.Service.ClientApi.net10.0)](https://img.shields.io/nuget/dt/MetaFrm.Service.ClientApi.net10.0)](https://www.nuget.org/packages/MetaFrm.Service.ClientApi.net10.0/)
### .Net 9.0
...
```
<PackageReference Include="MetaFrm.Service.ClientApi.net10.0" Version="x.x.x" />
```

You can also install via the .NET CLI with the following command:

```
dotnet add package MetaFrm.Service.ClientApi.net10.0
```
